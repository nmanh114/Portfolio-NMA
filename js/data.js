...
window.DOSSIER_DATA = {
  ...
  evidence: [
    ...
    },
    {
      ...
      detail: {
        vi: "3 năm tôi luyện trong môi trường chuyên Toán chọn lọc. Xây dựng tư duy phân tích hệ thống, định lượng và sự tôn trọng đối với các quy luật logic chặt chẽ.",
        en: "Three formative years in an elite specialized mathematics environment. Cultivated systematic quantitative deduction and rigorous analytical discipline."
      },
      deduction: {
  ...
  caseRecords: [
    {
      ...
      title: {
        vi: "Gia sư Toán học — 3 Năm Giảng Dạy & Rèn Luyện Tư Duy",
        en: "Mathematics Tutoring — 3 Years of Didactic Investigation"
      },
      duration: {
        vi: "3 năm kinh nghiệm (2022 — Nay)",
        en: "3 Years Experience (2022 — Present)"
      },
      audience: {
      ...
      transferableNote: {
        vi: "Deduction: 3 năm gia sư chứng minh năng lực sư phạm, tư duy giải quyết vấn đề, sự kiên nhẫn, tinh thần trách nhiệm và khả năng diễn giải các vấn đề phức tạp thành ngôn ngữ rõ ràng, dễ hiểu.",
        en: "Deduction: 3 years of tutoring establishes proven pedagogical clarity, structured problem solving, unwavering patience, high responsibility, and the capacity to articulate complex logic into transparent terms."
      },
      timeline: [
  ...
  toolkit: [
    {
      id: "python",
      name: "Python",
      proofImage: "assets/images/certificates/python.jpg",
      objectType: { vi: "Sổ Tay Dữ Liệu Định Lượng", en: "Quantitative Data Notebook" },
      icon: "code",
      badge: "DATA PIPELINE",
      coreCapabilities: [
        { vi: "Nền tảng lập trình Python cơ bản", en: "Python programming fundamentals" },
        { vi: "Làm việc với cấu trúc DataFrame", en: "Working with DataFrame data structures" },
        { vi: "Đọc, truy xuất và xử lý dữ liệu từ CSV, JSON, Excel", en: "Reading, parsing & extracting data from CSV, JSON, Excel" },
        { vi: "Đang tự học nâng cao phục vụ phân tích dữ liệu", en: "Actively self-studying advanced Python for analytical pipelines" }
      ],
      investigationNote: {
        vi: "Công cụ số hóa phục vụ bóc tách các tập dữ liệu, chuẩn bị cho các mô hình phân tích kinh tế định lượng.",
        en: "Digital instrument used to parse structured datasets and prepare inputs for quantitative economic analysis."
      }
    },
    {
      id: "excel",
      name: "Microsoft Excel",
      proofImage: "assets/images/certificates/microsoft-excel.jpg",
      objectType: { vi: "Sổ Cái Bằng Chứng & Đối Chiếu", en: "Evidence Ledger & Cross-Check Matrix" },
      icon: "table",
      badge: "DATA PROCESSING",
      coreCapabilities: [
        { vi: "Xây dựng và thao tác bảng tổng hợp Pivot Table", en: "Designing and analyzing multi-variable Pivot Tables" },
        { vi: "Tra cứu và đối chiếu dữ liệu giữa các sheets", en: "Cross-sheet lookup, matching & data reconciliation" },
        { vi: "Xử lý dữ liệu phục vụ công việc và học tập", en: "Operational data transformation, sorting & cleaning" }
      ],
      investigationNote: {
        vi: "Hoạt động như một sổ cái kiểm toán dữ liệu: kiểm tra tính nhất quán, phát hiện sai lệch và đối chiếu đa chiều.",
        en: "Functions as an exhaustive ledger: auditing data consistency, spotting anomalies, and cross-referencing records."
      }
    },
    {
      id: "word",
      name: "Microsoft Word",
      proofImage: "assets/images/certificates/microsoft-word.jpg",
      objectType: { vi: "Hồ Sơ Văn Bản & Báo Cáo", en: "Official Document Dossier" },
      icon: "file-text",
      badge: "DOCUMENTATION",
      coreCapabilities: [
        { vi: "Soạn thảo văn bản hành chính & báo cáo chuyên môn", en: "Drafting formal reports, briefs & executive texts" },
        { vi: "Biên tập tài liệu và biên bản làm việc chuẩn xác", en: "Compiling structured records & meeting minutes" },
        { vi: "Trình bày văn bản chuẩn mực, rõ ràng, mạch lạc", en: "Standardized formatting with high editorial discipline" }
      ],
      investigationNote: {
        vi: "Ghi chép sự thật và các kết luận logic bằng ngôn ngữ văn bản chính xác, minh bạch, không mơ hồ.",
        en: "Recording verified facts and logical deductions in rigorous, structured, unambiguous written language."
      }
    },
    {
      id: "powerpoint",
      name: "Microsoft PowerPoint",
      proofImage: "assets/images/certificates/microsoft-powerpoint.jpg",
      objectType: { vi: "Bảng Trình Bày Ý Tưởng Dự Án", en: "Visual Case Presentation Board" },
      icon: "layout",
      badge: "VISUAL STORYTELLING",
      coreCapabilities: [
        { vi: "Xây dựng bài thuyết trình logic và chặt chẽ", en: "Structuring persuasive, step-by-step presentations" },
        { vi: "Xây dựng bản trình bày ý tưởng dự án trực quan", en: "Visualizing project proposals and strategic frameworks" },
        { vi: "Kể chuyện bằng dữ liệu (Data Storytelling)", en: "Translating analytical deductions into compelling narratives" }
      ],
      investigationNote: {
        vi: "Biến các phân tích số liệu phức tạp thành những lập luận trực quan, thuyết phục người nghe tiếp nhận luận điểm.",
        en: "Converting intricate numerical analysis into compelling visual presentations that lead audiences to deductive conclusions."
      }
    },
    {
      id: "ai",
      name: "Artificial Intelligence (AI)",
      proofImage: "assets/images/certificates/ai-coursera.jpg",
    ...
    },
    {
      ...
      proofImage: "assets/images/certificates/datapot-ai.jpg",
